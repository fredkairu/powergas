...
class Auth extends MY_Controller
{
    ...
    function getUsers()
    {
        ...
        $this->datatables
            ->select($this->db->dbprefix('users').".id as id, first_name, last_name, email, username, " . $this->db->dbprefix('groups') . ".name, active")
            ->from("users")
            ...
            <a href='" . site_url('auth/profile/$1') . "' class='tip' title='" . lang("edit_user") . "'><i class=\"fa fa-edit\"></i></a>
            </center>", "id");
