...
<?php 
  ...
  $attrib = array('role' => 'form','method'=>'POST');?>
  <div class="searchform" style="z-index:999;top:10px;background-color:white;">
              <?php  echo  form_open_multipart("welcome/monthlytrend", $attrib);?>
            <div class="row">
    ...
    <div class="form-group">
              ...
              <div class="col-md-2">
                  <div class="form-group">
                      <?= lang("Sales Type", "Sales Type"); ?>
                        <?php echo form_dropdown('sales_type',array("PSO"=>"PSO","SSO"=>"SSO"),($sales_type), 'id="sales_type"  class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("sales_type") . '"  style="width:100%;" ');?>
        ...
        if ($q->num_rows() > 0) {
            foreach (($q->result()) as $row) {
                ...
                <?php
                                                $batches=array("20"=>"First 20","40"=>"Next 20-40","60"=>"40-60","80"=>"60-80","100"=>"80-100","All"=>"All");
...
?>
  ...
  <div class="row">
      ...
      <div class="col-md-12" >
          ...
          <h4><?=$sales_type?> Monthly Trend <a href="#" class="exporttable2 pull-right">Export As Xls</a></h4>
            <div id="exceltable2">
                        ...
                        <tbody>
                           ...
                           <tr>
                               <td class="headcol"><?=$ctry["name"]?>  </td>
                                  <?php  foreach ($alldates as $datemonth)  {
                                      
                                      $value=round($ctry["salestotals"][$datemonth],2);
                                      if(empty($value)){$value=0;}
                                      ?>
                                
                           
                               <td title="<?=$ctry["name"]."|Period&nbsp;".$monthsalestotals?>"><?php  
                                   echo $value;
                                   $$datemonth+=$value;
                               ?></td>
                           <?php } ?>
		...
		<tr>
			...
			<?php 
                        foreach ($alldates as $month) { 
                          echo "<td title='".$month."'>".round($$month,2)."</td>";      
                        }
                        ?>
		</tr>
	</tfoot>
