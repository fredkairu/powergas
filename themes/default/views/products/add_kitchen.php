...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('Add_Outright_Product'); ?></h2>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    <div class="form-group" style="display: none">
                        ...
                        echo form_dropdown('warehouse', $cat, (isset($_POST['warehouse']) ? $_POST['warehouse'] : ($warehouse ? $warehouse->id : '')), 'class="form-control select" id="warehouse" placeholder="' . lang("select") . " " . lang("warehouse_name") . '" required="required" style="width:100%"')
                        ?>
                    </div>
                    <div class="form-group" style="display: none">
