<?php if ($Owner || $Admin) { ?>
    <ul id="myTab" class="nav nav-tabs">
        ...
        <li class="" style="display:none"><a href="#chart" class="tab-grey"><?= lang('chart') ?></a></li>
        <li class="" style="display:none"><a href="#sales" class="tab-grey"><?= lang('sales') ?></a></li>
        <li class="" style="display:none"><a href="#quotes" class="tab-grey"><?= lang('quotes') ?></a></li>
        <?php if($product->type == 'standard') { ?>
        <li class="" style="display:none"><a href="#purchases" class="tab-grey"><?= lang('purchases') ?></a></li>
        <li class="" style="display:none"><a href="#transfers" class="tab-grey"><?= lang('transfers') ?></a></li>
        <li class="" style="display:none"><a href="#damages" class="tab-grey"><?= lang('quantity_adjustments') ?></a></li>
        <?php } ?>
        <li class="" style="display:none"><a href="#returns" class="tab-grey"><?= lang('returns') ?></a></li>
...
<div class="tab-content">
                    ...
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu"
                                ...
                                <li style="display:none"><a href="<?= site_url('products/pdf/' . $product->id) ?>"><i
                                ...
                                <li style="display:none"><a data-target="#myModal2" data-toggle="modal"
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="col-sm-7">
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                        ...
                                        <tr>
                                            <td><?= lang("Business_Unit"); ?></td>
                                            <td><?php echo $product->business_unit; ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang("Franchise"); ?></td>
                                            <td><?php echo $product->franchise; ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang("Financial_Product_Family"); ?></td>
                        ...
                        <div class="buttons">
                            <div class="btn-group btn-group-justified">
                                ...
                                <div class="btn-group" style="display:none"><a
                                ...
                                <div class="btn-group" style="display:none"><a href="<?= site_url('products/pdf/' . $product->id) ?>"
                                ...
                                <?php if($product->type == 'standard') { ?>
                                <div class="btn-group" style="display:none"><a data-target="#myModal2" data-toggle="modal"
    ...
    <div id="chart" class="tab-pane fade" style="display:none">
