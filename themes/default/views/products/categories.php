<script>
    $(document).ready(function () {
        $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('products/getCategories') ?>',
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<?php echo site_url('system_settings/add_category'); ?>" data-toggle="modal"
                               ...
                               <li><a href="<?php echo site_url('system_settings/import_categories_csv'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-upload"></i> <?= lang('import_category') ?></a></li>
