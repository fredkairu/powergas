            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group standard" style="display:none">
                        ...
                        <div
                            class="input-group" style="display:none"> <?= form_input('alert_quantity', (isset($_POST['alert_quantity']) ? $_POST['alert_quantity'] : ($product ? $this->sma->formatNumber($product->alert_quantity) : '')), 'class="form-control tip" id="alert_quantity"') ?>
                    ...
                    <div class="form-group standard">
                        ...
                        <div class="row" id="supplier-con" style="display:none">
                            <div class="col-md-8 col-sm-8 col-xs-8">
                                ...
                                ?></div>
                            <div
                                class="col-md-4 col-sm-4 col-xs-4" style="display:none"><?= form_input('supplier_price', (isset($_POST['supplier_price']) ? $_POST['supplier_price'] : ""), 'class="form-control tip" id="supplier_price" placeholder="' . lang('supplier_price') . '"') ?></div>
                        </div>
                ...
                <div class="col-md-6 col-md-offset-1">
                      ...
                      <div class="form-group all" style="display:none">
                        <?= lang("Marco_Code", "epdis_code") ?>
                        <?= form_input('epdis_code', (isset($_POST['epdis_code']) ? $_POST['epdis_code'] : ($product ? $product->epdis_code : '')), 'class="form-control" id="code"  placeholder="Marco" ') ?>
                    ...
                    <div class="form-group" style="display:none">
                        ...
                        echo form_dropdown('business_unit', $optss, (isset($_POST['business_unit']) ? $_POST['business_unit'] : ($product ? $product->business_unit : '')), 'class="form-control" id="business_unit" required="required"');
                        ?>
                    </div>
                    <div class="form-group all" style="display:none">
                    ...
                    <div class="form-group all"  style="display:none">
                      ...
                      <div class="form-group all" style="display:none">
                        <?= lang("Family", "family") ?>
                        <?= form_input('family', (isset($_POST['family']) ? $_POST['family'] : ($product ? $product->family : '')), 'class="form-control" id="code"  required="required"') ?>
