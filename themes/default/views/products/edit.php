                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                     ...
                     <div class="form-group all" style="display:none">
                        <?= lang("Mercafar_gmid", "mercafar_gmid") ?>
                        <?= form_input('mercafar_gmid', (isset($_POST['mercafar_gmid']) ? $_POST['mercafar_gmid'] : ($product ? $product->mercafar_gmid : '')), 'class="form-control" id="mercafar_gmid"   placeholder="Mercafar Gmid"') ?>
                        <span class="help-block"><?= lang('you_scan_your_barcode_too') ?></span>
                    </div>
                    <div class="form-group" style="display:none">
                        <?= lang("product_bu", "business_unit") ?>
                        <?php
                         $bus=$this->settings_model->getBU();
                        foreach($bus as $bu){
                            $optss[$bu->name]=$bu->name;
                        }
                        echo form_dropdown('business_unit', $optss, (isset($_POST['business_unit']) ? $_POST['business_unit'] : ($product ? $product->business_unit : '')), 'class="form-control" id="business_unit" ');
                        ?>
                    </div>
                    <div class="form-group" style="display:none">
                        <?= lang("Product_Promotion ", "promoted") ?>
                        <?php
                        $op = array('1' => lang('Promoted'), '0' => lang('Non Promoted'));
                        echo form_dropdown('promoted', $op, (isset($_POST['promoted']) ? $_POST['promoted'] : ($product ? $product->promoted : '')), 'class="form-control" id="promoted" ');
                        ?>
                    </div>
                  <!--  <div class="form-group all">
                        <?= lang("Product Promotion", "promoted") ?>
                        <?php
                       
                       $promotion=array("1"=>"promoted","0"=>"Non Promoted");
                        echo form_dropdown('promoted', $promotion, (isset($_POST['promoted']) ? $_POST['promoted'] : ($product ? $product->promoted : '')), 'class="form-control select" id="promoted" placeholder="' . lang("select") . " " . lang("Promotion_type") . '" required="required" style="width:100%"')
                        ?>
                    </div>-->
                   <!-- <div class="form-group all" style="display:none">
                    ...
                    <div class="form-group all">
                       ...
                       <select class="form-control" id="planned_checked" name='typ'>
                           <option value="std">Standard</option>
                           <option value="gas">Gas</option>
                       </select>
                    </div>
                    
                    <div class="form-group all" id="txtKgs">
                        <label>KGS</label>
                   ...
                   <div class="form-group all" style="display:none">
                        <?= lang("Finance_Product_Family", "family") ?>
                        <?= form_input('family', (isset($_POST['family']) ? $_POST['family'] : ($product ? $product->family : '')), 'class="form-control" id="code" ') ?>
                        <span class="help-block"><?= lang('Input_product_family') ?></span>
                    </div>
                    <!--<div class="form-group all">
                    ...
                    <div class="form-group all">
                     ...
                     <div class="form-group all" style="display:none">
                         <?= lang("Product_franchise", "franchise") ?>
                        <?php
                        $chc[''] = "";
                        foreach ($chcfranchise as $franchise) {
                            $chc[$franchise->name] = $franchise->name;
                        }
                        echo form_dropdown('franchise', $chc, (isset($_POST['franchise']) ? $_POST['franchise'] : ($product ? $product->franchise : '')), 'class="form-control select" id="franchise" placeholder="' . lang("select") . " " . lang("Product_franchise") . '"  style="width:100%"')
                        ?>
                    </div>
...
<div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                        <a href="<?php echo site_url('products'); ?>" class="btn btn-info" role="button">Cancel</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        var text = document.getElementById("txtKgs");
        text.style.display = "none";
        $('#planned_checked').on('change', function() {
          if(this.value=='gas') {
