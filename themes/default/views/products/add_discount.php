<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open("products/add_discount/".$product->id, $attrib); ?>
        <div class="modal-body">

            <div class="form-group">
                <?= lang("Range From", "range_from") ?>
                <input id="range_from" type="number" name="range_from"  class="form-control">
            </div>
            <div class="form-group">
                <?= lang("Range To", "range_to") ?>
                <input id="range_to" type="number" name="range_to"  class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="loyalty_points" type="number" name="loyalty"  class="form-control">
            </div>
        </div>
