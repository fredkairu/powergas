<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open("products/import_distributor_names", $attrib);
        // print_r($distributor_products1);
        ?>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <table id="PRData" class="table table-bordered table-condensed table-hover table-striped" width="90%">
                        <thead>
                            <tr class="primary"><th>#</th><th>Given Country</th><th>Distributor Name</th><th>Distributor P/Name</th><th>Distributor P/Code</th></tr></thead>
                <?php 
                $count=1;
             //print_r($distributor_products);
               foreach($distributor_products1 as $dp){ ?>
               ...
               while ($i< 5) {
                ...
                ?>
                    ...
                    echo "<option value='".$db->id."'>".$db->name."(".$country->country.")</option>";
                                    ...
                                    </select></td><td width="70%"><input type="text" class="form-control" id="pnamenew"></td><td><a class="addition btn btn-primary">Add Mapping</a></td></tr>
