            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                       ...
                       <?php $types=array("lowproduct"=>"Low Product","expiry"=>"Expiry","sales"=>"Sales","lowstock"=>"Low Stock","overstock"=>"Over Stock","products"=>"Products"); ?>
                        <div class="controls">
                            <?php echo form_dropdown('type', $types,$notification->type, 'class="form-control select" id="type"  required="required" style="width:100%"');?>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo lang('destination_emails', 'destination_emails'); ?>
                        <div class="controls">
                            <?php echo form_input('destination_emails',$notification->destination_emails, 'class="form-control" id="destination_emails" placeholder ="Email addresses separated by comma," required="required"'); ?>
                        </div>
                    </div>
                </div>
            </div>
