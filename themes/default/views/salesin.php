...
<?php 
  ...
  <div class="searchform" style="margin-top:10px;margin-bottom:30px;background-color:white;width:100%">
              <?php  echo  form_open_multipart("welcome/si", $attrib);?>
            <div class="row">
               <!-- <div class="col-md-2">
            ...
            foreach (($q->result()) as $row) {
              ...
              <div class="col-md-3">
                     <div class="form-group">
                      ...
                      echo form_dropdown('period[]',$months,($post['period']), 'id="period" multiple="multiple"  class="form-control input-tip select" required="required"  data-placeholder="' . lang("select") . ' period" style="width:100%;" ');?>   
    ...
    <div class="col-md-6" style="overflow-x:scroll;overflow-y:no-scroll;">
          <div class="panel panel-white">
                                             <div class="panel-heading" style="text-align:center">
                                                 Periodic Sales:K€ 
               <div id="siperiodic" style="width:container;height:400px;background-color:#fff">
...
<div class="row">
    ...
    <div class="col-md-6" style="overflow-x:scroll;max-width:1500px">
          <div class="panel panel-white">
               ...
               <div id="siytdvariance" style="width:content-box;height:400px;background-color:#fff">
...
/**********************variance**************/
console.log([<?=$siperiodicvariance?>]);
   var chartv = AmCharts.makeChart("siperiodicvariance", {
    "theme": "none",
    "type": "serial",
      "columnSpacing":2,
    "dataProvider":[<?=$siperiodicvariance?>],
    "valueAxes": [{
      //  "stackType": "1d",
       // "unit": "%",
       
       // "position": "left",
        "title": "SI Sales Variance"
    }],
    "startDuration": 0,
    "graphs": [{
        "labelText": "[[value]]",
...
/**********variance**************/
var chartv = AmCharts.makeChart("siytdvariance", {
    "theme": "none",
    "type": "serial",
      "columnSpacing":2,
