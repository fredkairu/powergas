...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_bu'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("system_settings/edit_bu", $attrib); ?>
...
<!--             <div class="form-group">
             ...
             <div class="form-group all">
                 ...
                 <input id="name" type="text" name="name" value="<?=$bu->name?>" class="form-control input" required="required" style="width:100%"> 
                    </div>
...
<div class="form-group">
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_bu', lang('edit_business_unit'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
