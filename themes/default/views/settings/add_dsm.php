...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_DSM'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("system_settings/post_dsm", $attrib); ?>
...
<!--             <div class="form-group">
            ...
            <div class="form-group">
                <?php echo lang('DSM_Title*', 'name'); ?>
                <div class="controls">
                   <?php echo form_input('name', '', 'class="form-control" id="dsm_name"'); ?>
                </div>
            </div>
               <div class="form-group">
            ...
            <div class="form-group">
                        ...
                        <?php echo form_dropdown('business_unit', $arrbu,$bu1->business_unit, 'class="form-control tip select" id="business_unit" style="width:100%;" required="required"'); ?>
                     ...
                     <div class="form-group all" style="display:none">
                        ...
                        <div class="controls" id="team_namei"> <?php
                            echo form_input('team_name', ($product ? $product->subcategory_id : ''), 'class="form-control" id="team_name"  placeholder="' . lang("team_name") . '"');
                            ?>
                        </div>
                    </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_dsm', lang('Add_DSM'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
