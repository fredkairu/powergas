<script>
    $(document).ready(function () {
        $('#GPData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getAlignmentGroups') ?>',
...
<?= form_open('system_settings/alignment_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_alignment'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_customer_group1') ?></a>
                        </li>
                        ...
                        <li><a href="#" id="delete" data-action="delete"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_customer_groups1') ?></a></li>
