<script>
    $(document).ready(function () {
        $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getConversionrates') ?>',
...
<?= form_open('system_settings/conversion_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_conversion'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('Add_Conversion') ?></a></li>
