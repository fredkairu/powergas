                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_currency'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('Add_country') ?></a></li>
                               <li><a href="<?php echo site_url('system_settings/import_currency'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-upload"></i> <?= lang('Import_country_currency') ?></a></li>
                                <li><a href="<?php echo site_url('system_settings/product_pricing'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-upload"></i> <?= lang('Country_pricing_mapping') ?></a></li>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="introtext"><?php echo $this->lang->line("list_results"); ?> <a href="<?=site_url('/system_settings/country_pricing_categorized')?>" class="btn btn-primary pull-right"><i class="fa fa-search"></i>Search Prices </a></p>
