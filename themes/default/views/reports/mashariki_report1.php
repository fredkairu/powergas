...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('Mashariki Report'); ?> <?php
            if ($this->input->post('start_date')) {
                             ...
                             <div class="col-sm-4" >
                                ...
                                <label class="control-label" for="biller"><?= lang("Distributor"); ?></label>
                                    ...
                                    $cp[$comp->id] = $comp->name."  (".$country->country.")";
                                     ...
                                     echo form_dropdown('customer[]', $cp, $_POST['customer'], 'id="customer" class="form-control input-tip select " multiple="multiple" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("") . '"  style="width:100%;" ');?>
                   ...
                   <div class="col-sm-4" >
                                ...
                                <label class="control-label" for="biller"><?= lang("Customer"); ?></label>
                                    ...
                                    $cpc[$comp1->id] = $comp1->name."  (".$country->country.")";
                                     ...
                                     echo form_dropdown('customer1[]', $cpc, $_POST['customer1'], 'id="customer1" class="form-control input-tip select " multiple="multiple" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("") . '"  style="width:100%;" ');?>
                ...
                $products[$row->id] = $row->name."(".$row->code.")";
                 	...
                 	<div class="col-sm-4">
                            <div class="form-group">
                                ...
                                $cluteam[""] = "Select Team";
                                foreach ($tm as $teams) {
                                    $cluteam[$teams->team_name] = $teams->team_name;
                                }
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                $cludsm[""] = "Select dsm";
                                    ...
                                    $cludsm['2'] ='DSM Name';
                                echo form_dropdown('team[]', $cludsm, (isset($_POST['team']) ? $_POST['team'] : ""), 'class="form-control" multiple="multiple" id="team" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("team_name") . '"');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('team[]', $clumsr, (isset($_POST['team']) ? $_POST['team'] : ""), 'class="form-control" multiple="multiple" id="team" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("team_name") . '"');
                                ?>
                            </div>
                        </div>
