<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('budgets/getCountrySSOBudget')?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            },null,null,null,null,null,null, {"bSortable": false}], //{"mRender": row_status} ,{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}
...
//                nCells[13].innerHTML = currencyFormat(parseFloat(balance));
           ...
           {column_number: 1, filter_default_label: "[<?=lang('Month');?>]", filter_type: "text", data: []}, 
            {column_number: 2, filter_default_label: "[<?=lang('Country');?>]", filter_type: "text", data: []},
            ...
            {column_number: 4, filter_default_label: "[<?=lang('Product');?>]", filter_type: "text", data: []},
             {column_number: 5, filter_default_label: "[<?=lang('Quantity Units');?>]", filter_type: "text", data: []},
             {column_number: 6, filter_default_label: "[<?=lang('Value');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?= lang('Country SSO Budgets'); ?>
        </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('budgets/import_country_sso_budgets') ?>"><i class="fa fa-plus-circle"></i> <?= lang('import_budget') ?></a></li>
