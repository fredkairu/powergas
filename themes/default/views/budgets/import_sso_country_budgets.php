...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('Import Country SSO Budget'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("budgets/import_country_sso_budget", $attrib);
                ...
                <div class="row">
                    <div class="col-lg-12" >
                        ...
                        <?php } else {
                            ...
                            echo form_input($biller_input);
                             ...
                             <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $options = array(""=>"Select Option","budget"=>"Budget","forecast"=>"Forecast");
                         ...
                         <div class="col-md-4" style="display:none">
                             ...
                             <div class="form-group">
                                ...
                                <?php $pst = array(""=>"SCENARIO",'PSO' => lang('Primary'), 'SSO' => lang('Secondary'),'SI' => lang('Sales In'));
                             ...
                             <div class="form-group">
                                <?= lang("Month", "smonth"); ?>
                                <input type="text" placeholder="mm/yyyy"  class="form-control input-tip datepicker"  id="smonth" name="smonth" required="required">
						...
						<div class="col-md-12" id="epdispso" style="display:none">
                            ...
                            <div class="well well-sm">
                                ...
                                <?php echo $this->lang->line("csv2"); ?>: <br> <span
                                    class="text-info"><?=strtolower("(YEAR,MONTH,GMID,MOVEMENT CODE,Quantity,Discount,SCENARIO,CUSTOMER,COUNTRY)")?></span> <br>
                                <?= lang('All_Fields_are_required'); ?>
                            </div>
                        </div>
			
						<div class="col-md-12" id="ssosales" style="display:block">
                            <div class="clearfix"></div>
                            <div class="well well-sm">
                                ...
                                <span class="text-warning"><?php echo $this->lang->line("csv1"); ?></span><br>
                                <?php echo $this->lang->line("csv2"); ?> <br><span
                                    class="text-info"><?=strtolower("(YEAR,MONTH,GMID,MOVEMENT CODE,Quantity,Discount,SCENARIO,CUSTOMER,COUNTRY)")?> 
</span><br>
                                <?= lang('All_fields_are_required'); ?>
                            </div>
                        </div>
                        	<div class="col-md-12" id="sibudget" style="display:none">
                            <div class="clearfix"></div>
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/sibudgets.csv"
                                   class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample
                                    File (SI BUDGET)</a>
                                <span class="text-warning"><?php echo $this->lang->line("csv1"); ?></span><br>
                                <?php echo $this->lang->line("csv2"); ?> <br><span
                                    class="text-info"><?=strtolower("(YEAR,MONTH,GMID,MOVEMENT CODE,QTY,Discount,Sales at Unified,Sales at Supply,Sales at Resale,SCENARIO,CUSTOMER,COUNTRY)")?> 
</span><br>
                                <?= lang('All_fields_are_required'); ?>
                            </div>
                        </div>
