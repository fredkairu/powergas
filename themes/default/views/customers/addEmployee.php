<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Add_Employee'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'add-customer-form');
        echo form_open_multipart("customers/addEmployee", $attrib); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        echo form_dropdown('emp_grp', $optss, (isset($_POST['emp_grp']) ? $_POST['emp_grp'] : ($product ? $product->business_unit : '')), 'class="form-control" id="emp_grp" required="required"');
                        ?>
                    </div>
                   ...
                   <div class="form-group company">
                    ...
                    <div class="form-group">
                        <?= lang("Email", "email"); ?>
                        <input type="email" name="email" class="form-control" r id="email"/>
                    </div>
                    <div class="form-group">
                        <?= lang("phone", "phone"); ?>
                ...
                <div class="col-md-6">
                  <!--  <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <?php echo form_dropdown('country', $ctry,$country->country, 'class="form-control tip select" id="country" style="width:100%;" required="required"'); ?>
                    </div>
                    <div class="form-group" id="msr_a">
                        ...
                        <?php echo form_dropdown('msr_alignment', $temsr,$msr->msr_alignment_name, 'class="form-control tip select" id="msr_alignment" style="width:100%;" required="required"'); ?>
                    </div>
                    <div class="form-group" style="display:none" id="dsm_a">
                        ...
                        <?php echo form_dropdown('dsm_alignment', $temdsm,$dsm->dsm_alignment_name, 'class="form-control tip select" id="dsm_alignment" style="width:100%;" required="required"'); ?>
                    </div>
