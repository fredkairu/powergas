<script>
    $(document).ready(function () {
        var oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('customers/getEmployee') ?>',
...
<?php if ($Owner) {
    echo form_open('customers/employee_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('Employee'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('customers/addEmployee'); ?>" data-toggle="modal" data-target="#myModal"
                               id="add"><i class="fa fa-plus-circle"></i> <?= lang("Add_Employee"); ?></a></li>
                               
                        <li><a href="<?= site_url('customers/import_employee_csv'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus-circle"></i> <?= lang("import_employee_by_csv"); ?>
                            </a></li>
                        ...
                        <?php if ($Owner) { ?>
                            ...
                            <li><a href="#" class="bpo" title="<b><?= $this->lang->line("Delete_Employee") ?></b>"
