<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Edit_Msr_Customer_Alignment'); ?></h4>
        </div>

        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
         echo form_open_multipart("customers/edit_msr_customer/" . $customermsr->id, $attrib); ?>
 ...
 <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                     ...
                     <div class="form-group" id="msr_a">
                        ...
                        <?php echo form_dropdown('msr_alignment', $temsr,$customermsr->sf_alignment_id, 'class="form-control tip select" id="msr_alignment" style="width:100%;" required="required"'); ?>
                    </div>
                     <div class="form-group">
                        ...
                        <?php echo form_dropdown('product', $ctry,$customermsr->product_id, 'class="form-control tip select" id="product" style="width:100%;" required="required"'); ?>
                    </div>
                ...
                <div class="col-md-6">
                  <!--  <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <?php echo form_dropdown('customer', $ctry,$customermsr->customer_id, 'class="form-control tip select" id="customer" style="width:100%;" required="required"'); ?>
                    </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_msrcut', lang('Update_Alignment'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
