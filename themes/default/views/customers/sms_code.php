<script>
    $(document).ready(function () {
        var oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('customers/getSmsCodes') ?>',
            ...
            {column_number: 4, filter_default_label: "[<?=lang('token');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('SMS_Codes'); ?></h2>
