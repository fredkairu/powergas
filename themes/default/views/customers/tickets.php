<script>
    $(document).ready(function () {
        var oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('customers/getTickets') ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            },null, null, null, null, null, null, null, {"mRender": row_status5}, {"bSortable": false}]
        }).dtFilter([
            ...
            {column_number: 7, filter_default_label: "[<?=lang('Reason');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-ticket"></i><?= lang('Tickets'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li style="display:none"><a href="<?= site_url('customers/import_csv'); ?>" data-toggle="modal"
                        ...
                        <?php if ($Owner) { ?>
                            ...
                            <li><a href="#" class="bpo" title="<b><?= $this->lang->line("Delete_Sales_People") ?></b>"
                                   data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>"
                                   data-html="true" data-placement="left"><i
                                        class="fa fa-trash-o"></i> <?= lang('Delete_Sales_People') ?></a></li>
                        <?php } ?>
                    </ul>
                </li>
            </ul>
