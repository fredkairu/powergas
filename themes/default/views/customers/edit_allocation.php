<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h5 class="modal-title" id="myModalLabel"><?php echo lang($page_title); ?> FOR SHOP <span style="color:red"><?=$allocation[0]->shop_name?></span></h5>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form','enctype'=>'multipart/form-data','method'=>'POST');
        echo form_open("customers/edit_allocation/".$allocation[0]->id, $attrib); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_allocation', lang('edit_allocation'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
