<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h5 class="modal-title" id="myModalLabel"><?php echo lang($page_title); ?> FOR <span style="color:red"><?=$customer->name?></span></h5>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form','enctype'=>'multipart/form-data','method'=>'POST');
        echo form_open("customers/add_limit/".$customer->id, $attrib); ?>
        <input type="hidden" value="<?=$customer->id?>" name="customer_id" id="customer_id">
        <div class="modal-body">
            <div class="form-group">
                <?= lang("Cash Limit", "limit") ?>
                <input id="cash_limit" type="number" name="cash_limit"  class="form-control">
            </div>
        </div>
