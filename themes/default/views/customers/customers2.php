<script>
    $(document).ready(function () {
        var oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('customers/getCustomers2') ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null, {"mRender": row_status2}, {"bSortable": false}]
        }).dtFilter([
            ...
            {column_number: 5, filter_default_label: "[<?=lang('Route');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('Sales_People'); ?></h2>
