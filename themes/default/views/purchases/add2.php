<script type="text/javascript">
    ...
    localStorage.setItem('vehicle', <?php if($Owner){ echo '1'; }else{ echo '0'; } ?>);
</script>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("purchases/add2", $attrib)
                ?>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang("Vehicle", "posupplier"); ?>
                                            <div class="input-group">
                                                <input type="hidden" name="vehicle" value="" id="posupplier"
                                                       class="form-control" style="width:100%;"
                                                       placeholder="<?= lang("select") . ' ' . lang("vehicle") ?>">
