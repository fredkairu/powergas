            ...
            <div class="col-lg-12">
                ...
                <div class="well well-sm">
                    ...
                    <div class="col-xs-4 border-right">
                        ...
                        <div class="col-xs-10">
                            <h2 class=""><?= strtoupper($customer->name); ?></h2>
                    ...
                    <div class="col-xs-4">
                        ...
                        <div class="col-xs-10">
                            <h2 class=""><?= strtoupper($shop->shop_name); ?></h2>
                ...
                <div class="col-xs-8 pull-right">
                    <div class="col-xs-12 text-right">
                        <!--<?php $br = $this->sma->save_barcode($inv->id, 'code39', 70, false); ?>-->
                ...
                <div class="col-xs-4">
                    ...
                    <div class="col-xs-10">
                        <h2 class=""><?= lang("ref"); ?>: <?= $inv->id; ?></h2>

                       <p style="font-weight:bold;"><?= lang("date"); ?>: <?= $this->sma->hrld($inv->created); ?></p>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        ...
                        <div class="well well-sm">
                            ...
                            <p><?= lang("date"); ?>: <?= $this->sma->hrld($inv->created); ?></p>
                        ...
                        <?php if ($paypal->active == "1" && $inv->grand_total != "0.00") {
                            ...
                            <div class="col-xs-6 text-center">
                                <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                    ...
                                    <input type="hidden" name="item_name" value="<?= $inv->id; ?>">
                                    ...
                                    <input type="hidden" name="custom"
                                           value="<?= $inv->id . '__' . ($inv->grand_total - $inv->paid) . '__' . $paypal_fee; ?>">
                        ...
                        <?php if ($skrill->active == "1" && $inv->grand_total != "0.00") {
                            ...
                            <div class="col-xs-6 text-center">
                                <form action="https://www.moneybookers.com/app/payment.pl" method="post">
                                    ...
                                    <input type="hidden" name="ondemand_note" value="<?= $inv->id; ?>">
                                    ...
                                    <input type="hidden" name="detail1_description" value="<?= $inv->id; ?>">
                                    <input type="hidden" name="detail1_text"
                                           value="Payment for the sale invoice <?= $inv->id . ': ' . $inv->grand_total . '(+ fee: ' . $skrill_fee . ') = ' . $this->sma->formatMoney($inv->grand_total + $skrill_fee); ?>">
