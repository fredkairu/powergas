    ...
    $(document).ready(function () {
        ...
        'copy', 'excel', 'pdf'
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null,null,null,null,null,null,{"mRender": currencyFormat},null,null], //{"mRender": row_status} ,{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?= lang('sales') . ' ' . ($warehouse_id ? $warehouse->name : '') . ''; ?>
        </h2>
