        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <input type="checkbox" class="checkbox" name="actual_values" id="actual_values">
                        ...
                        <div class="col-md-3" id="sale_grp">
                             <div class="form-group">
                                ...
                                echo form_dropdown('type', $pst, '', 'class="form-control input-tip" required="required" id="type"'); ?>
                                    ...
                                    <div class="col-md-3" id="prtype" style="display:none">
                             <div class="form-group">
                                <?= lang("Price_Type", "prce_type"); ?>
                                <?php $prst = array('VE' => lang('Gross_Sales'), 'TN' => lang('Tender_Sale'),'NET' => lang('Net_Sale'));
                                echo form_dropdown('prce_type', $prst, '', 'class="form-control input-tip" required="required" id="prce_type"'); ?>
                             ...
                             <div class="form-group">
                                <?= lang("Year", "smonth"); ?>
                                <input type="text" placeholder="yyyy"  class="form-control input-tip datepicker monthPicker"  id="smonth" name="smonth" required="required" value="<?= date('Y');?>" autocomplete="off">
                        ...
                        <div class="col-md-12" id="salesintemplt" style="display:none">
                            <div class="clearfix"></div>
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/actualtemplate.csv"
                                   class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample 
                                    File (Actual Values)</a>
                                <span class="text-warning"><?php echo $this->lang->line("csv1"); ?></span><br>
                                <?php echo $this->lang->line("correct_movement_code_values"); ?> : <span>Gross Sales(VE),Tender (TN),Net Sales(NT).Ensure all columns are filled and date format is (YYYY-MM-DD)</span><br>  <?php //echo $this->lang->line("csv3"); ?><br>
						...
						<div class="col-md-12" id="epdispso">
                            <div class="clearfix"></div>
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/EPDPSOTemplate.csv"
                                   class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample
                                    File (PSO EPDIS/SOUTHAFRICA)</a>
                                <span class="text-warning"><?php echo $this->lang->line("csv1"); ?></span><br>
                                <?php echo $this->lang->line("csv2"); ?>: <br> <span
                                    class="text-info">( <?= lang("Month") . ', ' . lang("Country") . ', ' . lang("distributor") . ', ' . lang("GMID") . ', ' . lang("Product") . ', ' . lang("Qty").', ' . lang("Source"); ?> )</span> <br>
                                <?= lang('All_Fields_are_required'); ?>
                            </div>
                        </div>
												 <div class="col-md-12" id="mercarfapso" style="display:none">
                            <div class="clearfix"></div>
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/mercarfa PSO.csv"
                                   class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample
                                    File (PSO MARCAFA)</a>
                                <span class="text-warning"><?php echo $this->lang->line("csv1"); ?></span><br>
                                <?php echo $this->lang->line("csv2"); ?>: <br> <span
                                    class="text-info">( <?= lang("Marcafa_gmid") . ',  ' . lang("Movement_Code") . ',  ' . lang("Quantity") . ',' . lang("Discount").', ' . lang("Customer") . ', ' . lang("Customer_Country") . ', ' . lang("Distributor"); ?> )</span> <br>
                                <?= lang('first_3_are_required_other_optional'); ?>
                            </div>
                        </div>
						<div class="col-md-12" id="ssosales" style="display:none">
                            <div class="clearfix"></div>
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/SSO Sales Template.csv"
                                   class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample
                                    File GROSS/NET (SSO)</a>
                                 <a href="<?php echo $this->config->base_url(); ?>assets/csv/SSO_SALES_TENDER.csv"
                                   class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample
                                    File Tender (SSO)</a>
                                <span class="text-warning"><?php echo $this->lang->line("csv1"); ?></span><br>
                                <?php echo $this->lang->line("csv2"); ?> <br><span
                                    class="text-info">( <?= lang("Month") . ', ' . lang("Country") . ',' . lang("Distributor") . ', ' . lang("Customer"). ', ' . lang("Product"). ', ' . lang("Quantity"); ?> )</span><br>
                                <?= lang('All_fields_are_required'); ?>
                            </div>
                        </div>
                        ...
                        <div class="row" id="bt">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" style="display:none" >x`
...
//alert ("Test");
 if ($("#type").val()=="PSO"){
document.getElementById("salesintemplt").style.display = "none";
...
document.getElementById("epdispso").style.display = "none";
		}else if ($("#distributor").val()!="MARCAFA"){
			document.getElementById("mercarfapso").style.display = "none";
document.getElementById("epdispso").style.display = "block";
		}
...
{   
    ...
    $(".monthPicker").focus(function () {
     ...
     $('#actual_values').on('ifChecked', function (event) {
            ...
            $('#prtype').css('display','none');
            $('#sale_grp').css('display','none');
            $('#salesintemplt').css('display','block');
            $('#epdispso').css('display','none');
        });
        $('#actual_values').on('ifUnchecked', function (event) {
              $('#prtype').css('display','block');
            $('#sale_grp').css('display','block');
            $('#salesintemplt').css('display','none');
