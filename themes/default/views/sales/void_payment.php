<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('void_payment'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("sales/void_payment/" . $payment->id, $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="status">
                    <option value="received" <?= $payment->type == 'received' ? ' checked="checked"' : '' ?>>Received</option>
                    <option value="pending" <?= $payment->type == 'unconfirmed' ? ' checked="checked"' : '' ?>>Pending</option>
                </select>
            </div>

        </div>
        <div class="modal-footer">
            <?php echo form_submit('void_payment', lang('void_payment'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
