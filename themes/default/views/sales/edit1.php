                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        foreach ($countries as $acountry) {
                            $country[$acountry->french_name ] = $acountry->portuguese_name;
                        }
                                                                       echo form_dropdown('country', $country,(isset($_POST['country']) ? $_POST['country'] : $inv->sales_region), 'id="country" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("country") . '" required="required" style="width:100%;" ');
                                                ?>
                                            </div>
                                    </div>
                                    <div class="col-md-4" style="display:none">
