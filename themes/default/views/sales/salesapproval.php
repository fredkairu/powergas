<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sales/getApprovalSales?session_id='.$session_id)?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null,null,null,null,null,null,null,{"mRender": currencyFormat},{"mRender": currencyFormat},null, {"bSortable": false}], //{"mRender": row_status} ,{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}
...
//                nCells[13].innerHTML = currencyFormat(parseFloat(balance));
            ...
            {column_number: 2, filter_default_label: "[<?=lang('Movement_Code');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?= lang('sales_awaiting_approval'); ?>
        </h2>
                ...
                <div class="table-responsive">
                    <table id="SLData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("Movement_Code"); ?></th>
                           ...
                           <!-- <th><?php echo $this->lang->line("date"); ?></th>
                            ...
                            <th><?php echo $this->lang->line("Product Family"); ?></th>
                             ...
                             <th><?php echo $this->lang->line("Unified_Price"); ?></th>
                             <th><?php echo $this->lang->line("Resale_Price"); ?></th>
