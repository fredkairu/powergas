    ...
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, null,null,null,null,null,null, {"bSortable": false}], //{"mRender": row_status} ,{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}
...
//                nCells[13].innerHTML = currencyFormat(parseFloat(balance));
            ...
            {column_number: 3, filter_default_label: "[<?=lang('scenario');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('gmid');?>]", filter_type: "text", data: []},
            ...
            {column_number: 6, filter_default_label: "[<?=lang('customer');?>]", filter_type: "text", data: []},
             {column_number: 7, filter_default_label: "[<?=lang('GBU');?>]", filter_type: "text", data: []},
            {column_number: 8, filter_default_label: "[<?=lang('Product Family');?>]", filter_type: "text", data: []},
             {column_number: 9, filter_default_label: "[<?=lang('Cluster');?>]", filter_type: "text", data: []},
              {column_number:10, filter_default_label: "[<?=lang('Country');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?= lang('Deleted_sales') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
                ...
                <div class="table-responsive">
                    <table id="SLData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("Gmid/Code"); ?></th>
                            <th><?php echo $this->lang->line("Product"); ?></th>
                           <!-- <th><?php echo $this->lang->line("date"); ?></th>
                            
                            <th><?php echo $this->lang->line("biller"); ?></th>-->
                            <th><?php echo $this->lang->line("customer"); ?></th>
                            <th><?php echo $this->lang->line("GBU"); ?></th>
                            <th><?php echo $this->lang->line("Product Family"); ?></th>
                             <th><?php echo $this->lang->line("Cluster"); ?></th>
