...
<?php 
  ...
  <div class="searchform" style="z-index:999;top:10px;background-color:white;">
              <?php  echo  form_open_multipart("welcome/msrsummaryanalysis", $attrib);?>
            <div class="row">
    ...
    <div class="form-group">
        ...
        <div class="col-md-2">
                     <div class="form-group">
                      ...
                      echo form_dropdown('period[]',$currentmonths,($_POST['period']), 'id="period"  multiple="multiple"  class="form-control input-tip select"   data-placeholder="' . lang("select") . ' period" style="width:100%;" ');?>   
                ...
                <div class="col-md-4"><div class="form-group" style="padding-top:30px"><input type="submit" name="filter" value="Filter" class="btn btn-primary">&nbsp;<input type="submit" id="detailed" name="detailed" value="Det.Analysis" class="btn btn-primary">&nbsp;<input type="button" id="resetform" value="Reset" class="btn btn-info"></div>
                </div>
<?php echo form_close(); ?>         
                        ...
                        <tbody>
                           ...
                           foreach ($alldata as $ctry){
                               ...
                               ?>
                                   ...
                                   <?php 
                                      foreach ($ctry["team_members"] as $value) {?>
                           <tr>
                               <td><?=$ctry["team_name"]?></td>
                               <td> <?php echo $value->msr_alignment_name?></td>
                                  
                        
                       <td>
                                     <?php
                                    $budget= $this->budget_model->getMsrTotalBudgetForPeriod($newdates,$value->id,"ALL","budget",$filters);
                                   echo $budget;
                                   $targettotal+=$budget;
                                    ?>
                                   ...
                                   <?php
                                   $sale=$this->budget_model->getMsrTotalSalesForPeriod($newdates,$value->id,"ALL",$filters);
                                     echo $sale;
                                     $salestotal+=$sale;
                                     ?>      
                                    </td>
...
{   
   ...
   var geturl = "index.php/welcome/msranalysis?gbu=" +gbu+"&cluster="+$("#cluster").val()+"&countrys="+$("#f_country").val()+"&period="+$("#period").val()+"&gsales="+$("#gsales").val() ;
