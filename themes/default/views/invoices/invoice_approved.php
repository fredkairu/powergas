<script>
    $(document).ready(function () {
        ...
        'copy', 'excel', 'pdf'
            ...
            'sAjaxSource': '<?= site_url('sales/getApprovedInvoices'.($warehouse_id ? '/'.$warehouse_id : '')) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?= lang('Approved_Invoices') . ' ' . ($warehouse_id ? $warehouse->name : '') . ''; ?>
        </h2>
