                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <?php if (!$this->ion_auth->in_group('customer', $id) && !$this->ion_auth->in_group('supplier', $id)) { ?>
                                                <div class="form-group" style="display: none">
                                                    ...
                                                    <div class="controls">
                                                        <?php echo form_input('company','N/A', 'class="form-control" id="company" '); ?>
                                                    </div>
                                                </div>
                                            <?php } else {
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="no" style="display:none">
                                                                            <div class="form-group" style="display:none">
                                                                                ...
                                                                                echo form_input('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $user->biller_id), 'id="biller" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("biller") . '"  class="form-control input-tip select" style="width:100%;"');
                                                                                ?>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group" style="display:none">
                                                                                ...
                                                                                echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $user->warehouse_id), 'id="warehouse" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . '"  style="width:100%;" ');
                                                                                ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
