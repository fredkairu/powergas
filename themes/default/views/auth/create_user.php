                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
                            ...
                            <div class="form-group" style="display:none">
                                ...
                                <div class="controls">
                                    <?php $pwd="powergas001";?>
                                    <?php echo form_password('password',$pwd, 'class="form-control tip" id="password" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{4,}"'); ?>
                            ...
                            <div class="form-group" style="display:none">
                                ...
                                <div class="controls">
                                    <?php echo form_password('confirm_password',$pwd, 'class="form-control" id="confirm_password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" data-bv-identical="true" data-bv-identical-field="password" data-bv-identical-message="' . lang('pw_not_came') . '"'); ?>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5 col-md-offset-1">
                         ...
                         <!--   <div class="no" style="display:none">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $Settings->default_biller), 'id="biller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '"  class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                                ...
                                <div class="form-group" style="display:none">
                                    ...
                                    echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : ''), 'id="warehouse" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("warehouse") . '"  style="width:100%;" ');
                                    ?>
                                </div>
                            </div>-->
