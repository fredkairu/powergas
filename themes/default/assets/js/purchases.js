...
if (powarehouse = localStorage.getItem('powarehouse')) {
    $('#powarehouse').select2("val", powarehouse);
        ...
        if (posupplier = localStorage.getItem('posupplier')) {
            if(localStorage.getItem('vehicle')=='1'){
                var adres = site.base_url + "suppliers/suggestions";
                var adres2 = site.base_url+"suppliers/getSupplier/";
            }else{
                var adres = site.base_url + "vehicles/suggestions";
                var adres2 = site.base_url+"vehicles/getVehicle/";
            }
