...
function row_status3(x) {
    if(x == null) {
        return '';
    } else if(x == '1') {
        return '<div class="text-center"><span class="label label-danger">Reversed</span></div>';
    } else if(x == '0') {
        return '<div class="text-center"><span class="label label-success">Forwarded</span></div>';
    }else {
        return '<div class="text-center"><span class="label label-default">'+lang[x]+'</span></div>';
    }
}

function row_status4(x) {
    if(x == null) {
        return '';
    } else if(x == '1') {
        return '<div class="text-center"><span class="label label-success">Approved</span></div>';
    } else if(x == '2') {
        return '<div class="text-center"><span class="label label-danger">Declined</span></div>';
    }else {
        return '<div class="text-center"><span class="label label-warning">Pending</span></div>';
    }
}

function row_status5(x) {
    if(x == null) {
        return '';
    } else if(x == '1') {
        return '<div class="text-center"><span class="label label-success">Handled</span></div>';
    } else if(x == '0') {
        return '<div class="text-center"><span class="label label-warning">Pending</span></div>';
    }else {
        return '<div class="text-center"><span class="label label-warning">Pending</span></div>';
...
$(document).ready(function() {
    ...
    $('body').on('click', '.discount_link td:not(:first-child :last-child)', function() {
        $('#myModal').modal({remote: site.base_url + 'sales/modal_view2/' + $(this).parent('.discount_link').attr('id')});
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'sales/view/' + $(this).parent('.invoice_link').attr('id');
    });
    $('body').on('click', '.inv_link td:not(:first-child :last-child)', function() {
        $('#myModal').modal({remote: site.base_url + 'sales/modal_viewInvoice/' + $(this).parent('.inv_link').attr('id')});
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'sales/view/' + $(this).parent('.invoice_link').attr('id');
    });
    $('body').on('click', '.cheq_link td:not(:first-child :last-child)', function() {
        $('#myModal').modal({remote: site.base_url + 'sales/modal_viewCheque/' + $(this).parent('.cheq_link').attr('id')});
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'sales/view/' + $(this).parent('.invoice_link').attr('id');
    });
